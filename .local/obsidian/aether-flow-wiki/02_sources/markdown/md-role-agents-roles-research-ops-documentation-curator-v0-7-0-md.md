...
related_object_ids:
  ...
  - "VAULT-MD-ROLE-AGENTS-ROLES-RESEARCH-OPS-DOCUMENTATION-CURATOR-V0-7-0-MD"
  - "WIKI-MD-ROLE-AGENTS-ROLES-RESEARCH-OPS-DOCUMENTATION-CURATOR-V0-7-0-MD"
---

# MD-ROLE-AGENTS-ROLES-RESEARCH-OPS-DOCUMENTATION-CURATOR-V0-7-0-MD
...
- Source path: `.agents/roles/research_ops/documentation-curator.v0.7.0.md`
- Source registry: `MARKDOWN_SOURCE_REGISTRY.csv`
- Format: `markdown`
- Authority status: `project_control`
- Raw mirror: `01_raw/markdown/md-role-agents-roles-research-ops-documentation-curator-v0-7-0-md.md`
...
- `has_content_semantics` -> SEMANTIC-MD-ROLE-AGENTS-ROLES-RESEARCH-OPS-DOCUMENTATION-CURATOR-V0-7-0-MD (SEMANTIC-MD-ROLE-AGENTS-ROLES-RESEARCH-OPS-DOCUMENTATION-CURATOR-V0-7-0-MD)
- `has_vault_note` -> VAULT-MD-ROLE-AGENTS-ROLES-RESEARCH-OPS-DOCUMENTATION-CURATOR-V0-7-0-MD (VAULT-MD-ROLE-AGENTS-ROLES-RESEARCH-OPS-DOCUMENTATION-CURATOR-V0-7-0-MD)
- `generated_output` -> WIKI-MD-ROLE-AGENTS-ROLES-RESEARCH-OPS-DOCUMENTATION-CURATOR-V0-7-0-MD (wiki/markdown/md-role-agents-roles-research-ops-documentation-curator-v0-7-0-md.md)
- `has_wiki_note` -> WIKI-MD-ROLE-AGENTS-ROLES-RESEARCH-OPS-DOCUMENTATION-CURATOR-V0-7-0-MD (WIKI-MD-ROLE-AGENTS-ROLES-RESEARCH-OPS-DOCUMENTATION-CURATOR-V0-7-0-MD)
