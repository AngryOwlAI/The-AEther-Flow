# WIKI-MD-RESEARCH-CONTROL-DESIGN-NARROW-THEOREM-TASK-TEMPLATE

Generated metadata note. Not canonical authority. Update the source file and registry row, then regenerate.

## Source

- Source object: `MD-RESEARCH-CONTROL-DESIGN-NARROW-THEOREM-TASK-TEMPLATE`
- Source path: `research_control/design/narrow_theorem_task_template.md`
- Format: `markdown`
- Role: `research_control_design`
- Authority status: `project_control`
- Owner skill: `project-memory-system`
- Source hash: `5b0722677ae1c0224b66479d8e5dffd0adc5baa5b7919d6b86e2da488ba1ceb8`
