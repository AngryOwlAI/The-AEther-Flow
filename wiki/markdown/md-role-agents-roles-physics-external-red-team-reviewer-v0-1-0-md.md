# WIKI-MD-ROLE-AGENTS-ROLES-PHYSICS-EXTERNAL-RED-TEAM-REVIEWER-V0-1-0-MD

Generated metadata note. Not canonical authority. Update the source file and registry row, then regenerate.

## Source

- Source object: `MD-ROLE-AGENTS-ROLES-PHYSICS-EXTERNAL-RED-TEAM-REVIEWER-V0-1-0-MD`
- Source path: `.agents/roles/physics/external-red-team-reviewer.v0.1.0.md`
- Format: `markdown`
- Role: `role_contract`
