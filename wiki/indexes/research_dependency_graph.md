...
- Generated from tracked state as of: `2026-07-04T04:05:00Z`
- Source fingerprint: `bcc50b33eab0f2d2ed9fac7c9e0ada3e8244a910be78466513a523cfe3e394d6`
- Nodes: `12474`
- Edges: `49975`
...
| `agent_job` | `support_only` | 684 |
| `artifact` | `canonical_source` | 79 |
| `artifact` | `support_only` | 6466 |
| `blocked_burden` | `blocked` | 1932 |
| `claim_boundary` | `support_only` | 641 |
...
- Active task: `RT-20260704-002`
- Latest handoff: `handoff-0548`
- Handoff path: `research_control/handoffs/handoff-0548.yaml`
- Next action: Run one bounded v15 P14-T03 public status documentation update packet.
