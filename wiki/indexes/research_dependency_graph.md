...
- Generated from tracked state as of: `2026-07-08T03:17:12Z`
- Source fingerprint: `183eb03a55ec24efccbc1c0c2853dbdf39ff11d93ec9fa19d4e6788bda1e0c2e`
- Nodes: `16413`
- Edges: `59662`
...
| `agent_job` | `support_only` | 836 |
| `artifact` | `canonical_source` | 86 |
| `artifact` | `support_only` | 8655 |
| `blocked_burden` | `blocked` | 2990 |
| `claim_boundary` | `support_only` | 793 |
...
- Handoff path: `research_control/handoffs/handoff-0699.yaml`
- Next action: Run one bounded v18 P5-T01 post-P4 source-equivalence route selector.
