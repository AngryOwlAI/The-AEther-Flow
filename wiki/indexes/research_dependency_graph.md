...
- Generated from tracked state as of: `2026-07-02T02:42:00Z`
- Source fingerprint: `17f49b12f44c71f1340d4d0454b72a26fedc50827946142e08a649a7b5355f15`
- Nodes: `10178`
- Edges: `43641`
...
| `agent_job` | `support_only` | 597 |
| `artifact` | `canonical_source` | 79 |
| `artifact` | `support_only` | 5239 |
| `blocked_burden` | `blocked` | 1222 |
| `claim_boundary` | `support_only` | 596 |
...
- Handoff path: `research_control/handoffs/handoff-0461.yaml`
- Next action: Run one bounded v14 P6-T02 completion and handoff template update packet before current-frontier three-tier pilot or downstream physics routes.
