...
- Generated from tracked state as of: `2026-06-30T13:55:00Z`
- Source fingerprint: `c139f3a68417d1bc58f655e677e40921056ee11296693289ae93f7a24475d0f3`
- Nodes: `8353`
- Edges: `35341`
...
| `agent_job` | `support_only` | 519 |
| `artifact` | `canonical_source` | 79 |
| `artifact` | `support_only` | 4156 |
| `blocked_burden` | `blocked` | 974 |
| `claim_boundary` | `support_only` | 520 |
...
- Handoff path: `research_control/handoffs/handoff-0383.yaml`
- Next action: Run one bounded P7-T02 packet to create the red-team review artifact schema and validator. Preserve may_promote_claims=false and do not run the P7-T03 pilot review in the same packet.
