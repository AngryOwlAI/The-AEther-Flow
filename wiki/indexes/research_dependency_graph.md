...
- Generated from tracked state as of: `2026-07-21T13:27:51Z`
- Source fingerprint: `9988bcba04a628e7cd6f16b7bb4315527d3d332ec45a78449474845e0357cd9e`
- Nodes: `20337`
- Edges: `69252`
...
| `agent_job` | `support_only` | 1026 |
| `artifact` | `canonical_source` | 86 |
| `artifact` | `support_only` | 10519 |
| `blocked_burden` | `blocked` | 3904 |
| `claim_boundary` | `support_only` | 983 |
| `draft_control_candidate` | `draft_control` | 678 |
| `draft_control_candidate` | `proposal_only` | 110 |
| `draft_control_candidate` | `science_draft` | 64 |
| `frozen_negative` | `frozen_negative` | 128 |
| `gate_chair_verdict` | `human_gated` | 31 |
| `handoff` | `support_only` | 795 |
| `human_gated_object` | `human_gated` | 443 |
| `ledger_row` | `accepted_scoped` | 5 |
| `ledger_row` | `blocked` | 4 |
| `ledger_row` | `frozen_negative` | 1 |
| `ledger_row` | `human_gated` | 1 |
| `ledger_row` | `science_draft` | 4 |
| `obstruction` | `blocked` | 78 |
...
| `source_ontology_object` | `support_only` | 331 |
| `task` | `human_gated` | 29 |
| `task` | `science_draft` | 32 |
| `task` | `support_only` | 965 |
...
- Handoff path: `research_control/handoffs/handoff-0795.yaml`
- Next action: Run exactly one bounded v21 P3-T05 ontology-formalizer packet constructing a proposal-only quotient-based EqSrc candidate with equivalence and congruence obligations plus positive and negative witness pairs.
