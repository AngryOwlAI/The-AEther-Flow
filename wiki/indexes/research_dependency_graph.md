...
- Generated from tracked state as of: `2026-07-06T05:24:23Z`
- Source fingerprint: `d4bbf772076aa0b88be3dae7ea8a8fed9f419d3f0b704e0ec51f75ef40a755e2`
- Nodes: `14600`
- Edges: `55723`
...
| `agent_job` | `support_only` | 771 |
| `artifact` | `canonical_source` | 82 |
| `artifact` | `support_only` | 7729 |
| `blocked_burden` | `blocked` | 2389 |
| `claim_boundary` | `support_only` | 728 |
| `draft_control_candidate` | `draft_control` | 500 |
...
| `source_ontology_object` | `support_only` | 277 |
| `task` | `human_gated` | 29 |
| `task` | `science_draft` | 30 |
| `task` | `support_only` | 712 |
...
- Handoff path: `research_control/handoffs/handoff-0635.yaml`
- Next action: Run one bounded v17 P4-T04 Refuter stress of the detector-replacement candidate and this audit.
