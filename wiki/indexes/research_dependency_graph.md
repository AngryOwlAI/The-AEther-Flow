...
- Generated from tracked state as of: `2026-06-30T03:14:05Z`
- Source fingerprint: `7ca65342af33c1d807d65d7484650a3db6cef73a2ced7a2b1a2bbe6dd6bc1c4f`
- Nodes: `7663`
- Edges: `32170`
...
| `agent_job` | `support_only` | 494 |
| `artifact` | `canonical_source` | 79 |
| `artifact` | `support_only` | 3798 |
| `blocked_burden` | `blocked` | 837 |
| `claim_boundary` | `support_only` | 495 |
...
| `handoff` | `support_only` | 358 |
| `human_gated_object` | `human_gated` | 221 |
...
- Handoff path: `research_control/handoffs/handoff-0358.yaml`
