...
- Generated from tracked state as of: `2026-07-06T03:11:46Z`
- Source fingerprint: `b599c6e29999f6e691185711c3cb5997c87c53d5521d1a35c1d12eadf31d7ef9`
- Nodes: `14479`
- Edges: `55464`
...
| `agent_job` | `support_only` | 767 |
| `artifact` | `canonical_source` | 82 |
| `artifact` | `support_only` | 7660 |
| `blocked_burden` | `blocked` | 2358 |
| `claim_boundary` | `support_only` | 724 |
...
- Handoff path: `research_control/handoffs/handoff-0631.yaml`
- Next action: Run one bounded v17 P3-T06 acceptance calibration red-team review.
