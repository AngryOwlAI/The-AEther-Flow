...
- Generated from tracked state as of: `2026-07-29T16:54:52Z`
- Source fingerprint: `f5821d639a12240fad6da660797e2b311d7676cde4c6694c297c80e9c10f7a99`
- Nodes: `23196`
- Edges: `74376`
...
| `agent_job` | `support_only` | 1140 |
| `artifact` | `canonical_source` | 87 |
| `artifact` | `support_only` | 11785 |
| `blocked_burden` | `blocked` | 4701 |
| `claim_boundary` | `support_only` | 1097 |
...
| `source_ontology_object` | `support_only` | 367 |
| `task` | `human_gated` | 29 |
...
- Handoff path: `research_control/handoffs/handoff-0901.yaml`
- Next action: Run one governed checkpoint for AJ-RT-20260729-005-001. Only after it commits may one fresh bounded P8-T03 candidate-constructor packet attempt to construct the typed closure datum and local effective-action candidate or prove one exact scoped obstruction without target matching.
