...
- Generated from tracked state as of: `2026-07-07T09:57:09Z`
- Source fingerprint: `08f7ff0f0b98091fb4178d74cbc8c1490a58eda6465882dde962d81b4b9d576b`
- Nodes: `15846`
- Edges: `58426`
...
| `agent_job` | `support_only` | 818 |
| `artifact` | `canonical_source` | 86 |
| `artifact` | `support_only` | 8341 |
| `blocked_burden` | `blocked` | 2821 |
| `claim_boundary` | `support_only` | 775 |
...
- Handoff path: `research_control/handoffs/handoff-0681.yaml`
- Next action: Run one bounded v18 P2-T01 source-equivalence typed-object problem-statement packet.
