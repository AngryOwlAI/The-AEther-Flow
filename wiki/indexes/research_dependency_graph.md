...
- Generated from tracked state as of: `2026-07-29T18:13:28Z`
- Source fingerprint: `2a20b77721997dd50c75363cfaabd94e4eacd9128adec6d64d31f14275015ce8`
- Nodes: `23230`
- Edges: `74426`
...
| `agent_job` | `support_only` | 1141 |
| `artifact` | `canonical_source` | 87 |
| `artifact` | `support_only` | 11802 |
| `blocked_burden` | `blocked` | 4708 |
| `claim_boundary` | `support_only` | 1098 |
| `draft_control_candidate` | `draft_control` | 772 |
| `draft_control_candidate` | `proposal_only` | 145 |
| `draft_control_candidate` | `science_draft` | 86 |
| `frozen_negative` | `frozen_negative` | 145 |
| `gate_chair_verdict` | `human_gated` | 33 |
| `handoff` | `support_only` | 902 |
| `human_gated_object` | `human_gated` | 562 |
| `ledger_row` | `accepted_scoped` | 6 |
| `ledger_row` | `blocked` | 3 |
| `ledger_row` | `frozen_negative` | 1 |
| `ledger_row` | `human_gated` | 1 |
| `ledger_row` | `science_draft` | 4 |
| `obstruction` | `blocked` | 95 |
...
| `source_ontology_object` | `support_only` | 368 |
| `task` | `human_gated` | 29 |
| `task` | `science_draft` | 33 |
| `task` | `support_only` | 1079 |
...
| Einstein-equations burden | `object:einstein_equations_burden` | `blocked_burden` | `blocked` | P8-T03 constructs an exact finite proposal-only quotient action and constraint with source-to-closure map finite Helmholtz gluing balance and spectral controls; |
...
- Handoff path: `research_control/handoffs/handoff-0902.yaml`
- Next action: Run one governed checkpoint for AJ-RT-20260729-006-001. Only after it commits may one fresh bounded P8-T04 ontology-formalizer packet vary the exact finite candidate, derive its constraint and identity structure, and compare it structurally without promoting it to an Einstein equation.
