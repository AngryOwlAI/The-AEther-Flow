...
- Generated from tracked state as of: `2026-07-05T05:45:00Z`
- Source fingerprint: `7c7063f1b328eca63a3aab68ace7afcb5dbe8177c7756fcb4baee56f2f4fd7ed`
- Nodes: `13503`
- Edges: `52898`
...
| `agent_job` | `support_only` | 726 |
| `artifact` | `canonical_source` | 82 |
| `artifact` | `support_only` | 7082 |
| `blocked_burden` | `blocked` | 2150 |
| `claim_boundary` | `support_only` | 683 |
| `draft_control_candidate` | `draft_control` | 484 |
...
| `handoff` | `support_only` | 590 |
| `human_gated_object` | `human_gated` | 281 |
...
- Active task: `RT-20260705-017`
- Latest handoff: `handoff-0590`
- Handoff path: `research_control/handoffs/handoff-0590.yaml`
- Next action: Run one bounded P9-T02 upstream trigger selector integration packet.
