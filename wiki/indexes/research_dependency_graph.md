...
- Generated from tracked state as of: `2026-07-06T23:54:18Z`
- Source fingerprint: `47bf2b435c97a8c4d49690c27aa14b847fba54378cb060f9216c2d867734ea46`
- Nodes: `15512`
- Edges: `57706`
...
| `agent_job` | `support_only` | 806 |
| `artifact` | `canonical_source` | 86 |
| `artifact` | `support_only` | 8204 |
| `blocked_burden` | `blocked` | 2675 |
| `claim_boundary` | `support_only` | 763 |
...
- Handoff path: `research_control/handoffs/handoff-0670.yaml`
- Next action: Run one bounded v17 P13-T03 current frontier and ledger synchronization packet.
