...
- Generated from tracked state as of: `2026-07-06T07:42:05Z`
- Source fingerprint: `545d918a967e56704cc5e64be5c0713f90defcc4452284472c9be9ca808f5550`
- Nodes: `14751`
- Edges: `56006`
...
| `agent_job` | `support_only` | 776 |
| `artifact` | `canonical_source` | 82 |
| `artifact` | `support_only` | 7802 |
| `blocked_burden` | `blocked` | 2441 |
| `claim_boundary` | `support_only` | 733 |
...
- Handoff path: `research_control/handoffs/handoff-0640.yaml`
- Next action: Run one bounded v17 P5-T04 metric-use frontier integration packet.
