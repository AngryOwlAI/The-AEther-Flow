...
- Generated from tracked state as of: `2026-07-05T06:20:00Z`
- Source fingerprint: `ab07df918d5dd286df6aad2adb1ddef8aeb61365023e1e1eca9a6ddd376da6da`
- Nodes: `13524`
- Edges: `52939`
...
| `agent_job` | `support_only` | 727 |
| `artifact` | `canonical_source` | 82 |
| `artifact` | `support_only` | 7098 |
| `blocked_burden` | `blocked` | 2150 |
| `claim_boundary` | `support_only` | 684 |
...
- Active task: `RT-20260705-018`
- Latest handoff: `handoff-0591`
- Handoff path: `research_control/handoffs/handoff-0591.yaml`
- Next action: Run one bounded P10-T01 source model zoo schema packet.
