...
- Generated from tracked state as of: `2026-07-06T21:09:04Z`
- Source fingerprint: `7fd325948f261945916f75365a4a8326879b82401d456a6104596411ebb8cf72`
- Nodes: `15416`
- Edges: `57415`
...
| `agent_job` | `support_only` | 801 |
| `artifact` | `canonical_source` | 86 |
| `artifact` | `support_only` | 8146 |
| `blocked_burden` | `blocked` | 2656 |
| `claim_boundary` | `support_only` | 758 |
...
- Handoff path: `research_control/handoffs/handoff-0665.yaml`
- Next action: Run one bounded v17 P12-T02 AI research-agent methodology metrics report extension packet through tooling-engineer@0.1.0 or an active compatible tooling overlay.
