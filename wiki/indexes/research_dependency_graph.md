...
- Generated from tracked state as of: `2026-07-08T11:20:48Z`
- Source fingerprint: `1db92f36873083b34ad9ddc9119dc5ef2c404db7ff666e86e24ec93597430af8`
- Nodes: `16763`
- Edges: `60485`
...
| `agent_job` | `support_only` | 849 |
| `artifact` | `canonical_source` | 86 |
| `artifact` | `support_only` | 8886 |
| `blocked_burden` | `blocked` | 3026 |
| `claim_boundary` | `support_only` | 806 |
...
- Handoff path: `research_control/handoffs/handoff-0712.yaml`
- Next action: Run one bounded v18 P7-T02 typed EqSrc orbit checker support-only implementation packet.
