...
- Generated from tracked state as of: `2026-07-04T06:18:25Z`
- Source fingerprint: `be4a64ec6e8c66ea925a623de5b0b700f11142707a5228548c88b6a1a6929dda`
- Nodes: `12511`
- Edges: `50099`
...
| `agent_job` | `support_only` | 685 |
| `artifact` | `canonical_source` | 79 |
| `artifact` | `support_only` | 6478 |
| `blocked_burden` | `blocked` | 1953 |
| `claim_boundary` | `support_only` | 642 |
...
- Active task: `RT-20260704-003`
- Latest handoff: `handoff-0549`
- Handoff path: `research_control/handoffs/handoff-0549.yaml`
- Next action: Run one bounded v15 P15-T01 support-only proof-assistant pilot scope selector packet.
