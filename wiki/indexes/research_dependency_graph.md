...
- Generated from tracked state as of: `2026-07-29T19:23:59Z`
- Source fingerprint: `fba90ff48a82de13f9dc746f3a8812b3654b95b7ce9924809c9e68e948a12f08`
- Nodes: `23262`
- Edges: `74480`
...
| `agent_job` | `support_only` | 1142 |
| `artifact` | `canonical_source` | 87 |
| `artifact` | `support_only` | 11819 |
| `blocked_burden` | `blocked` | 4711 |
| `claim_boundary` | `support_only` | 1099 |
| `draft_control_candidate` | `draft_control` | 773 |
| `draft_control_candidate` | `proposal_only` | 147 |
| `draft_control_candidate` | `science_draft` | 88 |
| `frozen_negative` | `frozen_negative` | 146 |
| `gate_chair_verdict` | `human_gated` | 33 |
| `handoff` | `support_only` | 903 |
...
| `source_ontology_object` | `support_only` | 369 |
| `task` | `human_gated` | 29 |
| `task` | `science_draft` | 32 |
| `task` | `support_only` | 1081 |
...
| Einstein-equations burden | `object:einstein_equations_burden` | `blocked_burden` | `blocked` | P8-T04 derives the exact finite proposal-only response equation solution source maps edge-flux and complete component-shift identities and records OBST-P8T04-FI |
...
- Handoff path: `research_control/handoffs/handoff-0903.yaml`
- Next action: Run one governed checkpoint for AJ-RT-20260729-007-001. Only after it commits may one fresh bounded P8-T05 refuter@0.2.0 packet solve and stress-test the exact finite equation for constraints, modes, characteristic structure, and stability without assuming a healthy GR limit.
