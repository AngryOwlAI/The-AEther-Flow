...
- Generated from tracked state as of: `2026-07-07T06:15:46Z`
- Source fingerprint: `c0e0702ef4de08e4fd0b489282d3fda5e262c502e85c393c2a21fb958b3fd93b`
- Nodes: `15663`
- Edges: `58047`
...
| `agent_job` | `support_only` | 812 |
| `artifact` | `canonical_source` | 86 |
| `artifact` | `support_only` | 8269 |
| `blocked_burden` | `blocked` | 2734 |
| `claim_boundary` | `support_only` | 769 |
...
- Handoff path: `research_control/handoffs/handoff-0675.yaml`
- Next action: Run one bounded v18 P0-T04 recommendation coverage seed packet before P1 active-state bifurcation P2 typed EqSrc work or downstream v18 tasks.
