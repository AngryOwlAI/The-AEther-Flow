...
- Generated from tracked state as of: `2026-07-06T15:47:20Z`
- Source fingerprint: `4c2b4791483a283f2d57b8b44949790fa7a54ca94a9b50257aa1c89ff80723b7`
- Nodes: `15230`
- Edges: `56985`
...
| `agent_job` | `support_only` | 793 |
| `artifact` | `canonical_source` | 85 |
| `artifact` | `support_only` | 8050 |
| `blocked_burden` | `blocked` | 2599 |
| `claim_boundary` | `support_only` | 750 |
...
- Handoff path: `research_control/handoffs/handoff-0657.yaml`
- Next action: Run one bounded v17 P10-T02 task-index generator packet through an active project-control tooling role overlay.
