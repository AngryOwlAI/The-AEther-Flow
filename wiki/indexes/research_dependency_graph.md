...
- Generated from tracked state as of: `2026-07-07T10:18:40Z`
- Source fingerprint: `c9b3898a3f0468a7c6e547a5dbaf743253d55a77d33f1c35bf141a54efba5f02`
- Nodes: `15879`
- Edges: `58493`
...
| `agent_job` | `support_only` | 819 |
| `artifact` | `canonical_source` | 86 |
| `artifact` | `support_only` | 8357 |
| `blocked_burden` | `blocked` | 2834 |
| `claim_boundary` | `support_only` | 776 |
...
- Handoff path: `research_control/handoffs/handoff-0682.yaml`
- Next action: Run one bounded v18 P2-T02 typed source-equivalence schema and registry packet.
