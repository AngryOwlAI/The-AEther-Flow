...
- Generated from tracked state as of: `2026-08-16T22:28:00Z`
- Source fingerprint: `86144f971fa7f3500582ec867a2f896dfd15ed155dfb656524748a94d582c5b5`
- Nodes: `28036`
- Edges: `81229`

<!-- generated-report-provenance: {"freshness_status":"fresh_at_generation","generated_view_is_authority":false,"generation_time":"2026-08-16T22:28:00Z","maximum_commit_lag":"1","physics_promotion_authorized":false,"policy_id":"p13_t07_live_generated_report_freshness_v1","proof_authority":false,"report_class":"research_dependency_graph","schema_id":"generated_report_provenance_v1","source_commit":"6dc67580d2b7692d01e23c5061fadc907d8fa97b","source_hashes":[{"path":"registries/AGENT_JOB_REGISTRY.csv","sha256":"f0927cd4c4061d6e4c012c83762a3601a649b57d486337c7ec2bf3e56ab23ceb"},{"path":"registries/DISTANCE_TO_GR_LEDGER.csv","sha256":"8b3aca0b7c5cd8aca4c0e4456ca423e2b0d0d63b1fe2f2a092a604554beff642"},{"path":"registries/RESEARCH_TASK_REGISTRY.csv","sha256":"8eecb5655f888dd3e34580fb494e536d1cc3aea42fdae0ef284853116c26d5ef"},{"path":"research_control/program_state.yaml","sha256":"0ba0b5c5441050cd91b2cb7cf120e1bdb91eabe2d7fb6408c6ab28b1a9330bbd"},{"path":"research_control/tasks/RT-20260801-011/artifacts/generated_report_freshness_metadata_schema_v1.yaml","sha256":"dc83260a771ac0bed94e150de76f83d8fb163dbe356f1532da11018fce06adc3"},{"path":"scripts/research_control/generated_report_provenance.py","sha256":"af417fa48220fbb4abffd9a4ab2cb93b4f9ea32f2f26e67e65dd6ad6ba4cee6c"},{"path":"scripts/research_control/render_dependency_graph.py","sha256":"6fdbe02623855697110263a90bbfbbd9a223ff636f320df497593fce3f9bef39"}],"source_manifest_sha256":"5862693128b320613d99eeeaada90a6dbe292a9d98181829b491cc2a2254e920","source_path_count":"2380","task_count":"1312"} -->
...
| Source commit | `6dc67580d2b7692d01e23c5061fadc907d8fa97b` |
| Source-derived generation time | `2026-08-16T22:28:00Z` |
| Tracked task count | 1312 |
| Exact source-path count | 2380 |
| Source manifest SHA-256 | `5862693128b320613d99eeeaada90a6dbe292a9d98181829b491cc2a2254e920` |
...
- `registries/AGENT_JOB_REGISTRY.csv`: `f0927cd4c4061d6e4c012c83762a3601a649b57d486337c7ec2bf3e56ab23ceb`
- `registries/DISTANCE_TO_GR_LEDGER.csv`: `8b3aca0b7c5cd8aca4c0e4456ca423e2b0d0d63b1fe2f2a092a604554beff642`
- `registries/RESEARCH_TASK_REGISTRY.csv`: `8eecb5655f888dd3e34580fb494e536d1cc3aea42fdae0ef284853116c26d5ef`
- `research_control/program_state.yaml`: `0ba0b5c5441050cd91b2cb7cf120e1bdb91eabe2d7fb6408c6ab28b1a9330bbd`
...
| `role_execution_registry` | 1 |
| `tex_source_registry` | 1 |
...
| `agent_job` | `support_only` | 1312 |
| `artifact` | `canonical_source` | 87 |
| `artifact` | `support_only` | 14267 |
| `blocked_burden` | `blocked` | 5745 |
| `claim_boundary` | `support_only` | 1269 |
| `draft_control_candidate` | `draft_control` | 1049 |
| `draft_control_candidate` | `proposal_only` | 191 |
| `draft_control_candidate` | `science_draft` | 121 |
| `frozen_negative` | `frozen_negative` | 181 |
| `gate_chair_verdict` | `human_gated` | 38 |
| `handoff` | `support_only` | 1055 |
| `human_gated_object` | `human_gated` | 658 |
| `ledger_row` | `accepted_scoped` | 6 |
| `ledger_row` | `blocked` | 3 |
| `ledger_row` | `frozen_negative` | 1 |
| `ledger_row` | `human_gated` | 1 |
| `ledger_row` | `science_draft` | 4 |
| `obstruction` | `blocked` | 124 |
| `obstruction` | `rejected` | 5 |
| `source_extension_evidence_precondition` | `source_extension_evidence` | 42 |
| `source_ontology_object` | `canonical_source` | 56 |
| `source_ontology_object` | `rejected` | 50 |
| `source_ontology_object` | `support_only` | 450 |
| `task` | `human_gated` | 29 |
| `task` | `science_draft` | 34 |
| `task` | `support_only` | 1249 |
...
| `blocked_claim:a_protected_gate_verdict_proof_promotion_publication_push_external_action_or_completed_derivation_exists` | Blocked claim: a protected Gate verdict proof promotion publication push external action or completed derivation exists | `registries/CLAIM_BOUNDARY_REGISTRY.csv` |
| `blocked_claim:a_protected_gate_verdict_proof_publication_push_external_action_or_completed_derivation_exists` | Blocked claim: a protected Gate verdict proof publication push external action or completed derivation exists | `registries/CLAIM_BOUNDARY_REGISTRY.csv` |
...
| `blocked_claim:absent_arm_cost_abandonment_or_outcome_values_represented_as_zero` | Blocked claim: absent arm cost abandonment or outcome values represented as zero | `registries/CLAIM_BOUNDARY_REGISTRY.csv` |
...
| `blocked_claim:action_measure_metric_coframe_connection_hodge_star_divergence_unit_normal_physical_clock_or_target_atlas_premise` | Blocked permission: action measure metric coframe connection Hodge star divergence unit normal physical clock or target-atlas premise | `registries/ROLE_EXECUTION_REGISTRY.csv` |
...
| `blocked_claim:adding_a_source_metric_orientation_order_root_label_presentation_carrier_admission_predicate_or_eqsrc_law` | Blocked permission: adding a source metric orientation order root label presentation carrier admission predicate or EqSrc law | `registries/ROLE_EXECUTION_REGISTRY.csv` |
| `blocked_claim:adequacy_evaluation` | Blocked permission: adequacy evaluation | `registries/ROLE_EXECUTION_REGISTRY.csv` |
| `blocked_claim:adequacy_evaluation_b2_activation_or_p4_t03_execution` | Blocked permission: adequacy evaluation B2 activation or P4-T03 execution | `registries/ROLE_EXECUTION_REGISTRY.csv` |
| `blocked_claim:adopted_matter_ontology_stress_energy_or_coupling` | Blocked claim: adopted matter ontology stress-energy or coupling | `registries/CLAIM_BOUNDARY_REGISTRY.csv` |
...
| `blocked_claim:agentjob_completion_handoff_sidecar_or_science_rewrite` | Blocked claim: AgentJob completion handoff sidecar or science rewrite | `registries/CLAIM_BOUNDARY_REGISTRY.csv` |
...
| `blocked_claim:aggregation_of_inconclusive_cases_into_a_pass` | Blocked claim: aggregation of INCONCLUSIVE cases into a pass | `registries/CLAIM_BOUNDARY_REGISTRY.csv` |
...
| `blocked_claim:ai_review_as_external_human_review_independent_replication_or_authorship` | Blocked claim: AI review as external human review independent replication or authorship | `registries/CLAIM_BOUNDARY_REGISTRY.csv` |
...
| `blocked_claim:aj_rt_20260809_006_001_or_checkpoint_replay` | Blocked claim: AJ-RT-20260809-006-001 or checkpoint replay | `registries/CLAIM_BOUNDARY_REGISTRY.csv` |
...
| `blocked_claim:ambiguous_shared_metrics_or_double_counted_budgets` | Blocked permission: ambiguous shared metrics or double-counted budgets | `registries/ROLE_EXECUTION_REGISTRY.csv` |
| `blocked_claim:an_incomplete_obligation_set_called_a_complete_instance` | Blocked claim: an incomplete obligation set called a complete instance | `registries/CLAIM_BOUNDARY_REGISTRY.csv` |
...
| `blocked_claim:any_frozen_route_is_reopened_reconstructed_superseded_or_used_to_choose_admissibility` | Blocked claim: any frozen route is reopened reconstructed superseded or used to choose admissibility | `registries/CLAIM_BOUNDARY_REGISTRY.csv` |
| `blocked_claim:any_frozen_route_reconstruction_repair_audit_or_stress` | Blocked claim: any frozen-route reconstruction repair audit or stress | `registries/CLAIM_BOUNDARY_REGISTRY.csv` |
| `blocked_claim:any_obligation_called_discharged` | Blocked claim: any obligation called discharged | `registries/CLAIM_BOUNDARY_REGISTRY.csv` |
| `blocked_claim:any_other_historical_byte_change` | Blocked claim: any other historical byte change | `registries/CLAIM_BOUNDARY_REGISTRY.csv` |
| `blocked_claim:any_other_p2_t01_artifact_mutation` | Blocked claim: any other P2-T01 artifact mutation | `registries/CLAIM_BOUNDARY_REGISTRY.csv` |
...
| `blocked_claim:any_semantic_yaml_change` | Blocked claim: any semantic YAML change | `registries/CLAIM_BOUNDARY_REGISTRY.csv` |
...
| `blocked_claim:arbitrary_lambda_values_as_derived_or_calibrated` | Blocked claim: arbitrary lambda values as derived or calibrated | `registries/CLAIM_BOUNDARY_REGISTRY.csv` |
...
| `blocked_claim:arbitrary_plan_inference` | Blocked claim: arbitrary plan inference | `registries/CLAIM_BOUNDARY_REGISTRY.csv` |
| `blocked_claim:arbitrary_plan_registration` | Blocked permission: arbitrary plan registration | `registries/ROLE_EXECUTION_REGISTRY.csv` |
...
| `blocked_claim:archive_copy_or_generated_manifest_as_canonical_authority` | Blocked claim: archive copy or generated manifest as canonical authority | `registries/CLAIM_BOUNDARY_REGISTRY.csv` |

## Route Continuity

- Active task: `RT-20260816-012`
- Latest handoff: `handoff-1055`
- Handoff path: `research_control/handoffs/handoff-1055.yaml`
- Next action: Run the single governed checkpoint for AJ-RT-20260816-012-001. Only after it commits may a fresh invocation execute one separately admitted theoretical-continuation-selector@0.1.0 packet PKT-V22-P4T02-B2-POST-IDEMPOTENT-EQUATION-DECORATION-REFUTER-THEORETICAL-CONTINUATION-SELECTION-V1. Do not execute that selector in this invocation or authorize candidate repair, source-law or ontology adoption, occurrence, probability, projector or quotient bridge adoption, D7, B2, P4-T03, physical or empirical claims, Gate action, promotion, publication, push, external action, future impossibility, or global no-go.
