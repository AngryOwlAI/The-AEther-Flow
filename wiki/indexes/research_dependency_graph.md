...
- Generated from tracked state as of: `2026-07-07T10:52:51Z`
- Source fingerprint: `d7fcc232fa6c5632ae9acf6b005223a4d8fc1b2866bec6f80530511075bc26af`
- Nodes: `15912`
- Edges: `58561`
...
| `agent_job` | `support_only` | 820 |
| `artifact` | `canonical_source` | 86 |
| `artifact` | `support_only` | 8372 |
| `blocked_burden` | `blocked` | 2848 |
| `claim_boundary` | `support_only` | 777 |
...
- Handoff path: `research_control/handoffs/handoff-0683.yaml`
- Next action: Run one bounded v18 P2-T03 initial typed source-equivalence registry population packet.
