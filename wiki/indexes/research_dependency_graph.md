...
- Generated from tracked state as of: `2026-07-05T23:55:00Z`
- Source fingerprint: `0ce9b908dff1814773926d6072d213b2b42b16c9b6900949859a0214909f5f56`
- Nodes: `14233`
- Edges: `54673`
...
| `agent_job` | `support_only` | 757 |
| `artifact` | `canonical_source` | 82 |
| `artifact` | `support_only` | 7517 |
| `blocked_burden` | `blocked` | 2314 |
| `claim_boundary` | `support_only` | 714 |
...
- Handoff path: `research_control/handoffs/handoff-0621.yaml`
- Next action: Run one bounded v17 P1-T04 Director handoff packet to choose the audit-lane disposition. Because P1-T03 passed the target floor the expected disposition is route_to_smuggling_audit.
