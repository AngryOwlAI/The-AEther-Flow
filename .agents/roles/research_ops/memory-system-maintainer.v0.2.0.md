...
The Memory-System Maintainer owns bridge signals involving memory query,
registry lookup, generated wiki, Obsidian, local cache, and retrieval-surface
freshness behavior. It must preserve the rule that local retrieval layers are
not authority.
