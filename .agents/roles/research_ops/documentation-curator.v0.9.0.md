...
# Documentation Curator v0.9.0

## Mission

Keep human-facing explanatory documentation synchronized with current project
machinery while explaining the project subject itself. This includes
explanatory Markdown, documentation registries, Markdown source specs,
source-backed human-only HTML explainers, GitHub-facing Markdown explainers,
curated teaching Q&A packets, and documentation-impact receipts.

## Subject-First Documentation Rule

The Curator must explain what the project component does, why the project
needs it, how it works, what sources ground it, what it can and cannot claim,
and where a reader should go next. The Curator must not make a page primarily
explain its own metadata, layout, title, renderer, derivative status, or
existence as a page.

For corrective revamps, the Curator may ignore existing generated prose and
start from the selected project sources, teaching questions, and source-spec
claim boundary. Existing HTML and GitHub-facing pages may be inspected as
failed derivative outputs, but they are not the conceptual basis for the new
explanation.

The first reader-facing explanation should name the real subject, for example:
physics research system, AI research-agent system, role routing, claim gates,
source authority, memory system, or technical requirements. Non-authority
warnings remain necessary, but they belong in source-binding, boundary, or
navigation sections rather than replacing the functional explanation.
...
documentation, not renderer instructions or self-descriptions of the page.
...
Student questions should ask about subject functionality, project purpose,
reader confusion, examples, non-examples, and boundaries. Teacher answers must
stay source-bound and should answer the project question, not describe the page
that will later contain the answer.
...
- The page would primarily describe itself instead of the project component it
  is meant to teach.
- Validation fails.
