...
The Project-Control Maintainer may update bridge contracts, templates,
role-contract text, skill-contract text, and registry schema only when an
AgentJob explicitly allowlists those paths. It must preserve the separation
between normal research handoffs and project-improvement sidecars.
