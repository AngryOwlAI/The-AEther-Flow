...
Reader scope: memory and retrieval orientation only. This page cannot change
memory-system behavior, registry schema, validator behavior, routing behavior,
role authority, checkpoint behavior, source authority, or physics status.
