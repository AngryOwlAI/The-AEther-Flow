---
topic_id: "TOPIC-RESEARCH-AGENT-SYSTEM"
explainer_subject: "Research-Agent System"
reader_question: "How does AEther-Flow turn research state into bounded work, evidence, validation, and handoff?"
title: "Research-Agent System"
purpose: "Explain the research-agent system as a source-backed Visual Atlas topic without changing project authority."
...
claim_boundary: "Human-only Visual Atlas explainer for Research-Agent System. It teaches the project mechanism without creating physics claims, control authority, role authority, routing behavior, validator behavior, write permissions, or generated-output authority."
human_visual_only: true
explainer_kind: "workflow_process"
interaction_model: "progressive_disclosure"
analysis_depth: "deep"
presentation_profile: "workflow_lifecycle"
layout_intent: "Use a concept-first atlas layout with a system map, authority matrix, examples, non-examples, source chips, and next-reading path for Research-Agent System."
required_controls:
  - "section_toc"
...
mermaid_diagrams:
  required: true
  ids:
    - "research-agent-system-map"
---

# Research-Agent System Spec

## Rendering Intent

Teach the research-agent system as a source-backed project mechanism. The explanation must start from the subject, not from page metadata, renderer behavior, or derivative status. Generated outputs remain human-readable derivatives.
...
Summary heading: `Summary of Research-Agent System`
...
- subject_summary: A source-backed summary of Research-Agent System with plain-language grounding in `AGENTS.md` and `research_control/README.md`.
