---
packet_id: "source-authority.teaching-qa.v0.1"
topic_slug: "source-authority"
source_spec: "markdown/html-explainer-specs/source-authority-explainer.md"
derived_outputs:
...
claim_boundary: "Explanatory Q&A only for Source Authority And Generated Derivatives. Does not change physics claims, role authority, routing behavior, validators, or generated-output authority."
authority_status: "curated_explanatory_support"
---

# Teaching Q&A Packet: Source Authority And Generated Derivatives
...
Readers can confuse source authority, generated documentation, and task permission when learning source authority and generated derivatives. The teaching loop repairs that confusion by asking concrete reader questions and answering only from the declared source bundle.
...
### A2
Plain answer:
Before changing project knowledge, an agent reads the source file and registry row, edits the canonical source, regenerates derivatives, and validates hashes.
...
### A3
Plain answer:
Invalid: citing a polished HTML explainer or `.local` search result as independent authority.
...
- Valid example: Before changing project knowledge, an agent reads the source file and registry row, edits the canonical source, regenerates derivatives, and validates hashes.
- Invalid non-example: Invalid: citing a polished HTML explainer or `.local` search result as independent authority.
