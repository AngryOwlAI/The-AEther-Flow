#!/usr/bin/env python3
"""Validate the v18 P3-T04 EqSrc family-closure smuggling audit."""
...
TASK_ROOT = REPO_ROOT / "research_control/tasks/RT-20260707-022"
TEX_PATH = TASK_ROOT / "artifacts/eqsrc_family_closure_smuggling_audit_v1.tex"
REPORT_PATH = TASK_ROOT / "artifacts/eqsrc_family_closure_smuggling_audit_validation.json"
...
TEX_OBJECT_ID = "TEX-V18-P3-T04-EQSRC-FAMILY-CLOSURE-SMUGGLING-AUDIT-V1"
FUSION_MD_OBJECT_ID = (
    "MD-RESEARCH-CONTROL-TASKS-RT-20260707-022-PARENT-FUSION-NOTES-"
    "EQSRC-FAMILY-CLOSURE-SMUGGLING-AUDIT"
)
RECEIPT_MD_OBJECT_ID = (
    "MD-RESEARCH-CONTROL-TASKS-RT-20260707-022-EQSRC-FAMILY-CLOSURE-"
    "SMUGGLING-AUDIT-RECEIPT"
)
...
REQUIRED_SECTIONS = [
    ...
    "Audit Method",
    "Theorem Branch Audit: Supplied versus Derived",
    "Countermodel Branch Audit",
    "Target-Import Audit Matrix",
    "Process-Authority Audit Matrix",
    "Family-Closure Source-Purity Lemma",
    "Audit Result",
    "Residual Risks and Repairs",
...
REQUIRED_TOKENS = [
    ...
    "not detected",
    "P3-T05 Refuter stress",
    "No repair is required before P3-T05",
    "no_distance_delta",
]
