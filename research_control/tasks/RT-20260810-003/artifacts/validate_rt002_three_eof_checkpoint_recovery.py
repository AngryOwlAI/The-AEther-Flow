#!/usr/bin/env python3
"""Validate the sealed three-file RT-20260810-002 EOF-only recovery."""
...
JOB_ID = "AJ-RT-20260810-003-001"
SOURCE_TASK_ID = "RT-20260810-002"
SOURCE_JOB_ID = "AJ-RT-20260810-002-001"
SOURCE_HANDOFF_ID = "handoff-0999"
SOURCE_HEAD = "cdab63ae17afd842bb432e4d85cb4cad54630b9f"
MANIFEST_PATH = (
    ROOT
    / "research_control/tasks/RT-20260810-003/artifacts/"
    "rt002_failed_checkpoint_dirty_state_manifest.yaml"
)
MANIFEST_SHA256 = "8017e32ac7717d6c1135af39583f3f759880582de993698d361b6cabb879e835"
FAILURE_EVIDENCE_PATH = (
    ROOT
    / "research_control/tasks/RT-20260810-003/artifacts/"
    "rt002_failed_checkpoint_evidence.yaml"
)
FAILURE_EVIDENCE_SHA256 = (
    "a7fe8d31aad236f279176e2b90bdff89eeda3aa65af0b5114c6ba3724465551b"
)
CHECKPOINT_RECEIPT_PATH = (
    ROOT
    / ".local/validation-receipts/"
    "8afbc6d6c1cc892533a3e7f8e45a1e2fb8243d85d803a1dadc854fe5c9fbe844/"
    "RUN-CHECKPOINT-bae0489d53de8aed/receipt.json"
)
CHECKPOINT_RECEIPT_SHA256 = (
    "4941f4e8d0f3d74e5489d69a5bd1391f515bc277b64a3001575341a1ad05acda"
)
FAILED_GATE_STDOUT_PATH = CHECKPOINT_RECEIPT_PATH.parent / "gates/0006-git_diff_check.stdout"
FAILED_GATE_STDOUT_SHA256 = (
    "bfaf278ce65b1456cf800332a6c3ef01c1727e81c14cb0b36c88b77aedfa7788"
)
REPORT_PATH = (
    ROOT
    / "research_control/tasks/RT-20260810-003/artifacts/"
    "rt002_three_eof_checkpoint_recovery_receipt.json"
)
...
def build_report() -> dict[str, Any]:
    ...
    if len(entries) != 63:
        errors.append(f"expected 63 manifest paths, observed {len(entries)}")
    if len(targets) != 3:
        errors.append(f"expected 3 targets, observed {len(targets)}")
    if set(targets) - set(entries):
    ...
    for relative, expected in entries.items():
        ...
        if relative in targets:
            ...
            if not yaml_valid:
                errors.append(f"target is not valid YAML: {relative}")
    ...
    return {
        "schema_id": "rt002_three_eof_checkpoint_recovery_receipt_v1",
        "task_id": TASK_ID,
        "job_id": JOB_ID,
        ...
        "strategy_id": "repair_rt002_three_eof_blanks_and_checkpoint_v1",
        ...
        "checks": {
            ...
            "rt002_science_reexecuted": False,
