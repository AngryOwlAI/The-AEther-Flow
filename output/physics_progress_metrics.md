...
| Metric | Value |
| --- | --- |
| `tasks_registered` | `848` |
| `jobs_registered` | `848` |
| `completions_read` | `848` |
| `physics_completions_read` | `467` |
| `claim_boundary_rows` | `805` |
| `active_claim_boundary_rows` | `795` |
| `completion_validation_status_counts` | `{"PASS": 820, "PASS_WITH_SURFACE_AUDIT_FINDINGS": 1, "unknown": 27}` |
| `tasks_with_forbidden_conclusion_summary` | `402` |
| `physics_promotion_authorized_true` | `27` |
| `physics_promotion_authorized_false` | `375` |
| `claim_boundary_rows_active` | `795` |
| `selector_tasks` | `102` |
...
| `selector_cycles_without_construction` | `83` |
...
| `distance_to_gr_delta_false_count` | `349` |
...
| --- | --- |
| `physics_completions_read` | `467` |
| `total_payload_items` | `982` |
| `tasks_since_last_distance_to_gr_delta` | `69` |
| `tasks_since_last_burden_discharged` | `71` |
...
| `gate_ready_cycles_without_gate_verdict` | `293` |
...
| `distance_delta` | `{"changed_false_count": 349, "changed_true_count": 183, "effect_counts": {"missing_effect": 685, "no_distance_delta": 163}, "records_read": 848}` |
| `separate_packet_counts` | `{"candidate_packet_count": 177, "freeze_packet_count": 256, "obstruction_packet_count": 34, "process_only_packet_count": 455, "theorem_packet_count": 119}` |
...
| `payload_density_summary` | `{"classified_item_count": 1458, "mathematical_payload_item_count": 896, "mathematical_payload_task_count": 393, "payload_class_counts": {"conditional_theorem": 21, "countermodel": 53, "dependency_map_update": 141, "documentation_only": 101, "finite_witness": 221, "new_definition": 49, "new_theorem_statement": 144, "obstruction": 149, "proof_attempt": 0, "proved_theorem": 1, "route_selector_only": 166, "source_extension_classification": 117, "validator_tooling_only": 295}, "payload_density": 0.61454, "process_only_item_count": 562, "process_only_task_count": 455, "task_count": 848, "task_payload_density": 0.463443}` |
...
| `audit_to_stress_survival` | Candidate life cycle | `partial` | `1.0116` | This is an aggregate route-stage proxy; candidate lineage across audit and stress is not yet deterministic. |
| `stress_survival_rate` | Candidate life cycle | `partial` | `0.3908` | Stress survival is counted only as a non-promotional candidate-status outcome. |
...
| `proof_to_process_ratio` | Payload balance | `measured` | `1.5943` | Payload balance compares mathematical payload items to process-only items; it is not proof authority. |
...
| `gate_ready_without_gate` | `gate_ready_cycles_without_gate_verdict` | `293` | `0` | `False` | `False` |
