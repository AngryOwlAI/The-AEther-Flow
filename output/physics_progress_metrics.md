...
| Metric | Value |
| --- | --- |
| `tasks_registered` | `863` |
| `jobs_registered` | `863` |
| `completions_read` | `863` |
| `physics_completions_read` | `470` |
| `claim_boundary_rows` | `820` |
| `active_claim_boundary_rows` | `810` |
| `completion_validation_status_counts` | `{"PASS": 835, "PASS_WITH_SURFACE_AUDIT_FINDINGS": 1, "unknown": 27}` |
| `tasks_with_forbidden_conclusion_summary` | `402` |
| `physics_promotion_authorized_true` | `27` |
| `physics_promotion_authorized_false` | `375` |
| `claim_boundary_rows_active` | `810` |
| `selector_tasks` | `103` |
...
| `distance_to_gr_delta_false_count` | `364` |
...
| `tasks_since_last_distance_to_gr_delta` | `72` |
| `tasks_since_last_burden_discharged` | `74` |
...
| `gate_ready_cycles_without_gate_verdict` | `296` |
...
| Metric | Value |
| --- | --- |
| `project_system_task_run_length` | `7` |
...
| `support_only_task_count_since_last_physics_payload` | `7` |
...
| `project_system_task_count` | `442` |
| `physics_bearing_task_count` | `386` |
| `support_only_task_count` | `458` |
| `physics_bearing_to_project_system_task_ratio` | `0.8733` |
| `new_mathematical_payload_to_support_only_task_ratio` | `2.2686` |
...
| `distance_delta` | `{"changed_false_count": 364, "changed_true_count": 183, "effect_counts": {"missing_effect": 685, "no_distance_delta": 178}, "records_read": 863}` |
| `separate_packet_counts` | `{"candidate_packet_count": 177, "freeze_packet_count": 257, "obstruction_packet_count": 34, "process_only_packet_count": 465, "theorem_packet_count": 119}` |
...
| `payload_density_summary` | `{"classified_item_count": 1478, "mathematical_payload_item_count": 904, "mathematical_payload_task_count": 398, "payload_class_counts": {"conditional_theorem": 21, "countermodel": 56, "dependency_map_update": 142, "documentation_only": 101, "finite_witness": 225, "new_definition": 49, "new_theorem_statement": 144, "obstruction": 149, "proof_attempt": 0, "proved_theorem": 1, "route_selector_only": 167, "source_extension_classification": 117, "validator_tooling_only": 306}, "payload_density": 0.611637, "process_only_item_count": 574, "process_only_task_count": 465, "task_count": 863, "task_payload_density": 0.461182}` |
...
| `proof_to_process_ratio` | Payload balance | `measured` | `1.5749` | Payload balance compares mathematical payload items to process-only items; it is not proof authority. |
...
| `gate_ready_without_gate` | `gate_ready_cycles_without_gate_verdict` | `296` | `0` | `False` | `False` |
