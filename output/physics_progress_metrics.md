...
| Metric | Value |
| --- | --- |
| `tasks_registered` | `1080` |
| `jobs_registered` | `1080` |
| `completions_read` | `1080` |
| `physics_completions_read` | `537` |
| `claim_boundary_rows` | `1037` |
| `active_claim_boundary_rows` | `899` |
| `completion_validation_status_counts` | `{"FAIL": 16, "PASS": 1034, "PASS_WITH_SURFACE_AUDIT_FINDINGS": 1, "PENDING": 1, "unknown": 28}` |
| `tasks_with_forbidden_conclusion_summary` | `495` |
| `physics_promotion_authorized_true` | `27` |
| `physics_promotion_authorized_false` | `468` |
...
| `distance_to_gr_delta_false_count` | `577` |
...
| --- | --- |
| `physics_completions_read` | `537` |
| `total_payload_items` | `1245` |
| `tasks_since_last_distance_to_gr_delta` | `139` |
| `tasks_since_last_burden_discharged` | `1` |
...
| `gate_ready_cycles_without_gate_verdict` | `362` |
...
| `new_mathematical_payload_count` | `1301` |
| `theorem_countermodel_candidate_count` | `595` |
...
| `project_system_task_count` | `537` |
| `physics_bearing_task_count` | `450` |
| `support_only_task_count` | `559` |
| `physics_bearing_to_project_system_task_ratio` | `0.838` |
| `new_mathematical_payload_to_support_only_task_ratio` | `2.3274` |
...
| Metric | Value |
| --- | --- |
| `physics` | `{"acceptance_criteria": {"declared_count": 27, "measured_record_count": 25, "not_measured_record_count": 531, "status": "partially_measured"}, "compute": {"measured_record_count": 0, "not_measured_record_count": 556, "status": "not_measured", "values_by_unit": {}}, "declared_acceptance_criterion_count": 27, "declared_durable_output_count": 23, "durable_outputs": {"declared_count": 23, "measured_record_count": 25, "not_measured_record_count": 531, "status": "partially_measured"}, "elapsed_effort": {"measured_record_count": 531, "not_measured_record_count": 25, "status": "partially_measured", "value_seconds": 34702.0}, "task_count_credit": 538}` |
| `project_system` | `{"acceptance_criteria": {"declared_count": 100, "measured_record_count": 25, "not_measured_record_count": 524, "status": "partially_measured"}, "compute": {"measured_record_count": 0, "not_measured_record_count": 549, "status": "not_measured", "values_by_unit": {}}, "declared_acceptance_criterion_count": 100, "declared_durable_output_count": 77, "durable_outputs": {"declared_count": 77, "measured_record_count": 25, "not_measured_record_count": 524, "status": "partially_measured"}, "elapsed_effort": {"measured_record_count": 527, "not_measured_record_count": 22, "status": "partially_measured", "value_seconds": 158075.0}, "task_count_credit": 542}` |
...
| `category_counts` | `{"mixed": 7, "physics_bearing": 531, "support_only": 107, "system_bearing": 435}` |
...
| `distance_delta` | `{"changed_false_count": 577, "changed_true_count": 183, "effect_counts": {"conditional_theorem_candidate": 19, "decision_evidence_only": 1, "evaluation_framework_only": 1, "frozen_negative": 1, "literature_basis_only": 1, "missing_effect": 718, "no_distance_delta": 317, "obstruction_recorded": 14, "review_calibration_only": 1, "scoped_evidence_precondition": 3, "scoped_source_extension_object": 4}, "records_read": 1080}` |
| `separate_packet_counts` | `{"candidate_packet_count": 206, "freeze_packet_count": 313, "obstruction_packet_count": 49, "process_only_packet_count": 617, "theorem_packet_count": 152}` |
...
| `payload_density_summary` | `{"classified_item_count": 1889, "mathematical_payload_item_count": 1133, "mathematical_payload_task_count": 462, "payload_class_counts": {"conditional_theorem": 32, "countermodel": 90, "dependency_map_update": 162, "documentation_only": 107, "finite_witness": 284, "new_definition": 69, "new_theorem_statement": 180, "obstruction": 170, "proof_attempt": 0, "proved_theorem": 1, "route_selector_only": 197, "source_extension_classification": 145, "validator_tooling_only": 452}, "payload_density": 0.599788, "process_only_item_count": 756, "process_only_task_count": 617, "task_count": 1079, "task_payload_density": 0.428174}` |
...
| --- | --- | --- | --- | --- |
| `overclaim_catch_rate` | Claim-boundary control | `measured` | `0.9455` | Forbidden-conclusion summaries are counted as eligible overclaim-control surfaces; caught means no physics promotion was authorized. |
...
| `proof_to_process_ratio` | Payload balance | `measured` | `1.4987` | Payload balance compares mathematical payload items to process-only items; it is not proof authority. |
...
| `gate_ready_without_gate` | `gate_ready_cycles_without_gate_verdict` | `362` | `0` | `False` | `False` |
