...
| Metric | Value |
| --- | --- |
| `tasks_registered` | `875` |
| `jobs_registered` | `875` |
| `completions_read` | `875` |
| `physics_completions_read` | `473` |
| `claim_boundary_rows` | `832` |
| `active_claim_boundary_rows` | `822` |
| `completion_validation_status_counts` | `{"PASS": 846, "PASS_WITH_SURFACE_AUDIT_FINDINGS": 1, "PENDING": 1, "unknown": 27}` |
| `tasks_with_forbidden_conclusion_summary` | `402` |
| `physics_promotion_authorized_true` | `27` |
| `physics_promotion_authorized_false` | `375` |
| `claim_boundary_rows_active` | `822` |
| `selector_tasks` | `104` |
...
| `selector_cycles_without_construction` | `85` |
...
| `distance_to_gr_delta_false_count` | `376` |
...
| --- | --- |
| `physics_completions_read` | `473` |
| `total_payload_items` | `988` |
| `tasks_since_last_distance_to_gr_delta` | `75` |
| `tasks_since_last_burden_discharged` | `77` |
| `new_payload_items_per_physics_task` | `2.09` |
...
| `gate_ready_cycles_without_gate_verdict` | `299` |
...
| Metric | Value |
| --- | --- |
| `project_system_task_run_length` | `8` |
| `physics_bearing_task_run_length` | `0` |
| `new_mathematical_payload_count` | `1042` |
| `theorem_countermodel_candidate_count` | `631` |
| `candidate_construction_count` | `177` |
| `support_only_task_count_since_last_physics_payload` | `8` |
...
| `project_system_task_count` | `453` |
| `physics_bearing_task_count` | `387` |
| `support_only_task_count` | `469` |
| `physics_bearing_to_project_system_task_ratio` | `0.8543` |
| `new_mathematical_payload_to_support_only_task_ratio` | `2.2217` |
...
| `distance_delta` | `{"changed_false_count": 376, "changed_true_count": 183, "effect_counts": {"missing_effect": 685, "no_distance_delta": 190}, "records_read": 875}` |
| `separate_packet_counts` | `{"candidate_packet_count": 177, "freeze_packet_count": 257, "obstruction_packet_count": 34, "process_only_packet_count": 476, "theorem_packet_count": 119}` |
...
| `payload_density_summary` | `{"classified_item_count": 1491, "mathematical_payload_item_count": 905, "mathematical_payload_task_count": 399, "payload_class_counts": {"conditional_theorem": 21, "countermodel": 56, "dependency_map_update": 143, "documentation_only": 104, "finite_witness": 225, "new_definition": 49, "new_theorem_statement": 144, "obstruction": 149, "proof_attempt": 0, "proved_theorem": 1, "route_selector_only": 168, "source_extension_classification": 117, "validator_tooling_only": 314}, "payload_density": 0.606975, "process_only_item_count": 586, "process_only_task_count": 476, "task_count": 875, "task_payload_density": 0.456}` |
...
| `route_orbit_rate` | Route dynamics | `measured` | `0.0042` | Repeated-burden streaks are process warnings only and do not change Distance-to-GR status. |
...
| `proof_to_process_ratio` | Payload balance | `measured` | `1.5444` | Payload balance compares mathematical payload items to process-only items; it is not proof authority. |
...
| `claimed_bridge_no_delta` | `tasks_since_last_distance_to_gr_delta` | `3` | `2` | `False` | `False` |
| `candidate_missing_result` | `candidate_constructor_result_missing_count` | `11` | `0` | `False` | `False` |
| `gate_ready_without_gate` | `gate_ready_cycles_without_gate_verdict` | `299` | `0` | `False` | `False` |
