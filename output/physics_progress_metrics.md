...
| Metric | Value |
| --- | --- |
| `tasks_registered` | `1038` |
| `jobs_registered` | `1038` |
| `completions_read` | `1038` |
| `physics_completions_read` | `530` |
| `claim_boundary_rows` | `995` |
| `active_claim_boundary_rows` | `899` |
| `completion_validation_status_counts` | `{"FAIL": 2, "PASS": 1006, "PASS_WITH_SURFACE_AUDIT_FINDINGS": 1, "PENDING": 1, "unknown": 28}` |
| `tasks_with_forbidden_conclusion_summary` | `467` |
| `physics_promotion_authorized_true` | `27` |
| `physics_promotion_authorized_false` | `440` |
...
| `distance_to_gr_delta_false_count` | `535` |
...
| Metric | Value |
| --- | --- |
| `project_system_task_run_length` | `3` |
...
| `support_only_task_count_since_last_physics_payload` | `3` |
...
| `project_system_task_count` | `503` |
| `physics_bearing_task_count` | `443` |
| `support_only_task_count` | `525` |
| `physics_bearing_to_project_system_task_ratio` | `0.8807` |
| `new_mathematical_payload_to_support_only_task_ratio` | `2.4381` |
...
| `distance_delta` | `{"changed_false_count": 535, "changed_true_count": 183, "effect_counts": {"conditional_theorem_candidate": 19, "decision_evidence_only": 1, "frozen_negative": 1, "literature_basis_only": 1, "missing_effect": 718, "no_distance_delta": 276, "obstruction_recorded": 14, "review_calibration_only": 1, "scoped_evidence_precondition": 3, "scoped_source_extension_object": 4}, "records_read": 1038}` |
| `separate_packet_counts` | `{"candidate_packet_count": 206, "freeze_packet_count": 311, "obstruction_packet_count": 49, "process_only_packet_count": 582, "theorem_packet_count": 151}` |
...
| `payload_density_summary` | `{"classified_item_count": 1833, "mathematical_payload_item_count": 1114, "mathematical_payload_task_count": 455, "payload_class_counts": {"conditional_theorem": 32, "countermodel": 85, "dependency_map_update": 158, "documentation_only": 106, "finite_witness": 279, "new_definition": 65, "new_theorem_statement": 179, "obstruction": 170, "proof_attempt": 0, "proved_theorem": 1, "route_selector_only": 195, "source_extension_classification": 145, "validator_tooling_only": 418}, "payload_density": 0.607747, "process_only_item_count": 719, "process_only_task_count": 582, "task_count": 1037, "task_payload_density": 0.438766}` |
...
| --- | --- | --- | --- | --- |
| `overclaim_catch_rate` | Claim-boundary control | `measured` | `0.9422` | Forbidden-conclusion summaries are counted as eligible overclaim-control surfaces; caught means no physics promotion was authorized. |
...
| `proof_to_process_ratio` | Payload balance | `measured` | `1.5494` | Payload balance compares mathematical payload items to process-only items; it is not proof authority. |
